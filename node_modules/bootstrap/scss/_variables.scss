...
$primary:       #FF8c21 !default;
$secondary:     #345861 !default;
$third:     #77BBCC !default;
$success:       $green !default;
$info:          $cyan !default;
$warning:       $yellow !default;
$danger:        $red !default;
$light:         #FDF5ED !default;
...
$table-variants: (
  ...
  "third":  shift-color($third, $table-bg-scale),
...
$navbar-light-color:                rgba($white, .9) !default;
...
// Mine - Mylenna
.txt-shadow{
    text-shadow: 2px 2px 10px $gray-800;
}
